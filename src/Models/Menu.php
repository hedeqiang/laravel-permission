...
namespace Hedeqiang\Permission\Models;

use Illuminate\Database\Eloquent\Relations\BelongsTo;
use Illuminate\Database\Eloquent\Relations\HasMany;
use Illuminate\Database\Eloquent\Relations\BelongsToMany;
use Illuminate\Database\Eloquent\Model;
use Hedeqiang\Permission\Exceptions\MenuDoesNotExist;
use Hedeqiang\Permission\Exceptions\MenuAlreadyExists;
use Hedeqiang\Permission\Contracts\Menu as MenuContract;
